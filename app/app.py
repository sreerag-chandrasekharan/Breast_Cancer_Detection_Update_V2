...
scaler = joblib.load(open("C:/Users/Sreerag/Documents/ML_chellange/Breast_Cancer_Detection_Update_V2/models/scaler.pkl", "rb"))
...
# ---- make predictions
model = joblib.load(open("C:/Users/Sreerag/Documents/ML_chellange/Breast_Cancer_Detection_Update_V2/models/model.pkl", "rb"))
